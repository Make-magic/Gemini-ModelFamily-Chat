...
export const useAppProps = (logic: ReturnType<typeof useAppLogic>) => {
  ...
  const sidebarProps = useMemo(() => ({
    ...
    onGenerateTitle: chatState.handleGenerateTitle,
  ...
  const chatAreaProps = useMemo(() => ({
    ...
    onResearchSearchClick: (text: string) => handleSuggestionClick('research', text),
    ...
    isResearchActive: activeSuggestionType === 'research',
    ...
    onToggleAutoCanvas: () => logic.setAppSettings(prev => ({ ...prev, autoCanvasVisualization: !prev.autoCanvasVisualization })),
    isAutoCanvasEnabled: !!appSettings.autoCanvasVisualization,
