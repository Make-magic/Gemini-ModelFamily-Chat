...
export const AboutSection: React.FC<AboutSectionProps> = ({ t }) => {
  ...
  const currentVersion = "1.9.2-beta3";
  ...
  return (
    <div className="flex flex-col items-center justify-center py-6 px-4 space-y-8 text-center h-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="max-w-lg space-y-6 flex flex-col items-center">
        ...
        <a
          href="https://github.com/Make-magic/Gemini-ModelFamily-Chat/releases"
          target="_blank"
        ...
        >
          ...
          <span className={`absolute inset-0 transition-all duration-300 ${isUpdateAvailable ? 'bg-gradient-to-r from-amber-400 via-orange-500 to-red-500' :
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
        <a
          href="https://github.com/Make-magic/Gemini-ModelFamily-Chat"
          target="_blank"
          rel="noopener noreferrer"
        ...
        {stars !== null && (
          <a
            href="https://github.com/Make-magic/Gemini-ModelFamily-Chat/stargazers"
            target="_blank"
            rel="noopener noreferrer"
