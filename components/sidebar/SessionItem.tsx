...
interface SessionItemProps {
  ...
  onGenerateTitle: (session: SavedChatSession) => void;
...
export const SessionItem: React.FC<SessionItemProps> = (props) => {
  const {
    ...
    onSelectSession, onTogglePinSession, onDeleteSession, onDuplicateSession, onOpenExportModal, onGenerateTitle,
    ...
    >
      ...
      {activeMenu === session.id && (
        <SessionItemMenu
          ...
          onGenerateTitle={() => { onGenerateTitle(session); setActiveMenu(null); }}
