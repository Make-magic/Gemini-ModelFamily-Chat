      ...
      <div className="p-6 flex flex-col gap-4">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 id="confirmation-modal-title" className="text-lg font-bold text-[var(--theme-text-primary)] mb-2 leading-tight">
              {title}
            </h3>
            <p id="confirmation-modal-description" className="text-sm text-[var(--theme-text-secondary)] leading-relaxed">
              {message}
            </p>
          </div>
        </div>
