...
export const FileConfigurationModal: React.FC<FileConfigurationModalProps> = ({ isOpen, onClose, file, onSave, t, isGemini3 }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} ariaLabelledBy="file-configuration-title" contentClassName="bg-[var(--theme-bg-primary)] rounded-xl shadow-2xl max-w-md w-full border border-[var(--theme-border-primary)]">
            <FileConfigHeader
                onClose={onClose}
                t={t}
