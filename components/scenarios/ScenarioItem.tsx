      ...
      "
        ...
        >
            ...
            <div className="flex-grow mb-2">
                <p className="text-xs text-[var(--theme-text-secondary)] leading-relaxed line-clamp-2 opacity-80 group-hover:opacity-100 transition-opacity">
            ...
            <div className="flex items-center justify-end gap-1 pt-2 border-t border-[var(--theme-border-secondary)]/50 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-all duration-200 translate-y-1 group-hover:translate-y-0">
                {isSystem && onView && (
