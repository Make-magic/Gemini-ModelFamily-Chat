...
export const ExportModal: React.FC<ExportModalProps> = ({ isOpen, onClose, onExport, exportingType, t }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={() => !exportingType && onClose()} ariaLabelledBy="export-message-title">
            <div 
            ...
            >
                <div className="flex-shrink-0 flex justify-between items-center p-3 sm:p-4 border-b border-[var(--theme-border-primary)]">
                    <h2 id="export-message-title" className="text-lg sm:text-xl font-semibold text-[var(--theme-text-link)] flex items-center">
