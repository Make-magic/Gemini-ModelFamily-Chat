...
export const headerTranslations = {
    ...
    canvasHelperActive_aria: { en: 'Canvas system prompt On', zh: '开启 Canvas' },
    canvasHelperInactive_aria: { en: 'Canvas system prompt Off', zh: '关闭 Canvas' },
    canvasHelperActive_title: { en: 'Canvas system prompt On', zh: '开启 Canvas' },
    canvasHelperInactive_title: { en: 'Canvas system prompt Off', zh: '关闭 Canvas' },
    ...
    headerModelSelectorTooltip_action: { en: `Click to change, or press 'Tab' to cycle`, zh: `按 'Tab' 键循环切换推荐模型` },
