...
export const headerTranslations = {
    ...
    canvasHelperInactive_aria: { en: 'Load Canvas prompt and save settings', zh: '关闭 Canvas' },
    canvasHelperActive_title: { en: 'Canvas system prompt Off', zh: '开启 Canvas' },
    canvasHelperInactive_title: { en: 'Load Canvas Prompt and save', zh: '关闭 Canvas' },
