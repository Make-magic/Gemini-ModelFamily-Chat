...
export const headerTranslations = {
    ...
    canvasHelperActive_aria: { en: 'Canvas System Prompt', zh: '开启 Canvas' },
    canvasHelperInactive_aria: { en: 'Canvas System Prompt', zh: '关闭 Canvas' },
    canvasHelperActive_title: { en: 'Canvas System Prompt', zh: '开启 Canvas' },
    canvasHelperInactive_title: { en: 'Canvas System Prompt', zh: '关闭 Canvas' },
