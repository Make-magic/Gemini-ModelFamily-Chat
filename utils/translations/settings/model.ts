...
export const modelSettings = {
    ...
    settingsThinkingIntensityLevel: { en: 'Intensity Level', zh: '强度等级' },
    ...
    thinking_level_minimal: { en: 'Minimal', zh: '极简' },
    thinking_level_low: { en: 'Low', zh: '低' },
    thinking_level_medium: { en: 'Medium', zh: '中' },
    thinking_level_high: { en: 'High', zh: '高' },
    settingsThinkingBudget_label: { en: 'Token Budget', zh: '令牌预算' },
    settingsThinkingBudget_desc: { en: 'Controls the maximum number of tokens the model can use for its internal thought process', zh: '控制模型内部思考过程可使用的最大令牌数' },
    tokens: { en: 'tokens', zh: '令牌' },
