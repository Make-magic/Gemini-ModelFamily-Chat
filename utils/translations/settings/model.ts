...
export const modelSettings = {
    ...
    settingsSystemPrompt: { en: 'System Prompt', zh: '系统提示词' },
    ...
    settingsThinkingCustom_placeholder: { en: 'Token budget', zh: '思考预算' },
    ...
    settingsModelSelection_help: { en: 'Click a model or "Set Active" to select it as default.', zh: '点击模型或“设为活动”将其设为默认。' },
    settingsModelSelection_active: { en: 'Active', zh: '活动' },
    settingsModelSelection_setActive: { en: 'Set Active', zh: '设为活动' },
    settings_pinned_label: { en: 'Pinned', zh: '已固定' },
    ...
    settingsThinkingIntensityLevel: { en: 'Intensity Level', zh: '思考等级' },
    settingsThinkingReasoningEnabled: { en: 'Reasoning Enabled', zh: '推理已开启' },
    thinking_gemini3_capabilities: { en: 'Gemini 3.0 Capabilities', zh: 'Gemini 3.0 特性' },
    thinking_level_minimal: { en: 'Minimal', zh: '微' },
    thinking_level_low: { en: 'Low', zh: '低' },
    thinking_level_medium: { en: 'Medium', zh: '中' },
    thinking_level_high: { en: 'High', zh: '高' },
    settingsThinkingBudget_label: { en: 'Token Budget', zh: '思考预算' },
    settingsThinkingBudget_desc: { en: 'Controls the maximum number of tokens the model can use for its internal thought process', zh: '控制模型内部思考过程可使用的最大 Token 数' },
    tokens: { en: 'tokens', zh: 'Token' },
    settingsModelSelection_addModel: { en: 'Add Model', zh: '添加模型' },
    settingsModelSelection_reset: { en: 'Reset', zh: '重置' },
