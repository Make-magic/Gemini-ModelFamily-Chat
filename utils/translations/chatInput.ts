...
export const chatInputTranslations = {
    ...
    addById_help: { en: 'Enter a valid Gemini API File URI, for example', zh: '请输入有效的 Gemini API 文件 URI，例如' },
    addById_error: { en: 'The File ID must start with files/.', zh: '文件 ID 必须以 files/ 开头。' },
    ...
    addByUrl_error: { en: 'Enter a valid YouTube URL.', zh: '请输入有效的 YouTube 链接。' },
    ...
    web_search_label: { en: 'Google Search', zh: '谷歌搜索' },
    web_search_short: { en: 'Search', zh: '搜索' },
    deep_search_label: { en: 'Deep Search', zh: '深度搜索' },
    deep_search_short: { en: 'Search +', zh: '搜索+' },
    ...
    live_session_start: { en: 'Start Live session', zh: '开始 Live 会话' },
    live_session_end: { en: 'End Live session', zh: '结束 Live 会话' },
    upload_waiting: { en: 'Waiting for upload', zh: '等待文件上传' },
    upload_waiting_detail: { en: 'Wait for the upload to complete before sending', zh: '文件上传完成后才能发送' },
    upload_uploading: { en: 'Uploading...', zh: '上传中...' },
    upload_processing: { en: 'Processing...', zh: '处理中...' },
    upload_cancelling: { en: 'Cancelling upload...', zh: '正在取消上传...' },
    upload_cancelled: { en: 'Cancelled', zh: '已取消' },
    upload_cancel: { en: 'Cancel upload', zh: '取消上传' },
    upload_retry: { en: 'Retry file upload', zh: '重试文件上传' },
    retry: { en: 'Retry', zh: '重试' },
    file_remove: { en: 'Remove file', zh: '移除文件' },
    file_configure: { en: 'Configure file', zh: '配置文件' },
    file_id_copy: { en: 'Copy File ID', zh: '复制文件 ID' },
    file_id_copied: { en: 'File ID copied', zh: '文件 ID 已复制' },
    error: { en: 'Error', zh: '错误' },
    quad_images_short: { en: '4 Images', zh: '4 张图片' },
